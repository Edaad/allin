...
export function Overview() {
    ...
    useEffect(() => {
        const fetchUserGames = async () => {
            ...
            try {
                ...
                const soonestGame = upcomingGames.length > 0 ? upcomingGames[0] : null;
    ...
    const handleAcceptInvitation = async (gameId, e) => {
        ...
        try {
            ...
            const newInvitations = invitations.filter(inv => inv._id !== gameId);
            ...
            <div className="logged-content-container">
                {user ? (
                    <div className="dashboard-heading">
                        <h1>Hi <span>{user.names.firstName}</span>!</h1>
                    </div>
                ) : (
                    <h1>Loading...</h1>
                )}
                        ...
                        <div className="games-overview">
                            <div className="game-section">
                                <div className="summary-header">
                                    ...
                                    <div
                                        ...
                                        onClick={() => navigate(`/dashboard/${userId}/games?tab=Upcoming Games`)}
                                    >
                                        View All
                                    </div>
                                </div>
                                {isLoading ? (
                                    ...
                                    <>
                                        {userGames.upcoming ? (
                                            ...
                                            <p className="no-games-message">No upcoming games</p>
                                        )}
                                    </>
                                )}
                            </div>
                            <div className="game-section">
                                <div className="summary-header">
                                    ...
                                    <div
                                        className="summary-link"
                                        onClick={() => navigate(`/dashboard/${userId}/games?tab=Past Games`)}
                                    >
                                        View All
                                    </div>
                                </div>
                                {isLoading ? (
                                    ...
                                    <>
                                        {userGames.past ? (
                                            ...
                                            <p className="no-games-message">No past games</p>
                                        )}
                                    </>
                                )}
                            </div>
                    ...
                    <div className="summary-secondary">
                        <div className="summary-item">
                            <div className="summary-header">
                                ...
                                <div
                                    className="summary-link"
                                    onClick={() => navigate(`/dashboard/${userId}/games?tab=Invitations`)}
                                >
                                    View All
                                </div>
                            </div>
                        ...
                        <div className="summary-item">
                                            ...
                                            <Profile
                                                ...
                                                refreshData={() => {
                                                    const fetchUserData = async () => {
                                                        ...
                                                        suggestionsResponse.then(response => {
                                                            const newSuggestions = response.data
                                                                .filter(u =>
                                                                    u.mutualFriendsCount >= 1 &&
                                                                    !res.data.friends.some(f => f._id === u._id) &&
                                                                    !res.data.friendRequests.some(f => f._id === u._id) &&
                                                                    !res.data.pendingRequests.some(f => f._id === u._id)
                                                                )
                                                                .sort((a, b) => b.mutualFriendsCount - a.mutualFriendsCount)
                                                                .slice(0, 5);
                            ...
                            {friends.length === 0 && friendRequests.length === 0 && suggestedFriends.length === 0 && (
